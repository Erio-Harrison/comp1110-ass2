...
public class Model {
    ...
    private void modelSetPlay(List<String> playerStatement) {
        ...
        for (String p : playerStatement) {
            ...
            while (!scores[l].equals("T")) {
                ...
                this.board.tiles[Integer.parseInt(settlers[0])][Integer.parseInt(settlers[1])].occupier = id;
                l++;
            }
            l++;
    ...
    private void toModel(String stateString) {
        ...
        for (Object j : islandState) {
            ...
            this.board.setBoardAttributes((String) j, 3, 0 );
